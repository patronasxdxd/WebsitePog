    ...
    OpenloginAdapter = class extends BaseAdapter {
      ...
      async connectWithProvider(params) {
        ...
        if (this.currentChainNamespace === CHAIN_NAMESPACES.SOLANA) {
          ...
          } = await import("./solanaProvider.esm-5PCSXCXP.js");
          ...
          } = await import("./ethereumProvider.esm-DCG7KY4S.js");
        ...
        if (finalPrivKey) {
          if (this.currentChainNamespace === CHAIN_NAMESPACES.SOLANA) {
            const {
              getED25519Key
            } = await import("./openloginEd25519.esm-D4F3MW7B.js");
...
//# sourceMappingURL=openloginAdapter.esm-F2TC2PDK.js.map
