...
var nodeCrypto2, _0n3, _1n3, _2n3, _3n, _8n, POW_2_2562, CURVE2, USE_ENDOMORPHISM, JacobianPoint, pointPrecomputes2, Point2, Signature2, hexes3, divNearest, POW_2_128, HmacDrbg, crypto4, TAGGED_HASH_PREFIXES, utils2;
var init_esm2 = __esm({
  "../node_modules/@noble/secp256k1/lib/esm/index.js"() {
    ...
    JacobianPoint = class {
      ...
      equals(other) {
        ...
        const { x: X1, y: Y1, z: Z1 } = this;
        const { x: X2, y: Y2, z: Z2 } = other;
        const Z1Z1 = mod2(Z1 ** _2n3);
        const Z2Z2 = mod2(Z2 ** _2n3);
      ...
      double() {
        const { x: X1, y: Y1, z: Z1 } = this;
        const A = mod2(X1 ** _2n3);
        const B = mod2(Y1 ** _2n3);
        const C = mod2(B ** _2n3);
        const D = mod2(_2n3 * (mod2((X1 + B) ** _2n3) - A - C));
        const E = mod2(_3n * A);
        const F = mod2(E ** _2n3);
      ...
      add(other) {
        ...
        const HH = mod2(H ** _2n3);
        const HHH = mod2(H * HH);
        const V = mod2(U1 * HH);
        const X3 = mod2(r ** _2n3 - HHH - _2n3 * V);
    ...
    utils2 = {
      ...
      privateAdd: (privateKey, tweak) => {
        ...
        return numTo32b(mod2(p + t, CURVE2.n));
      },
      ...
      pointAddScalar: (p, tweak, isCompressed) => {
        ...
        const t = normalizePrivateKey(tweak);
        const Q = Point2.BASE.multiplyAndAddUnsafe(P, t, _1n3);
        if (!Q)
...
*/
//# sourceMappingURL=chunk-MSAC2NWE.js.map
