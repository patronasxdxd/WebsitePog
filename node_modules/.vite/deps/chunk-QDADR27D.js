...
var import_lodash, import_loglevel, log, apiKey, embedHost, gatewayAuthHeader, gatewayEmbedHostHeader, sentry, tracingOrigins, tracingPaths, get;
...
var import_loglevel2, import_regenerator, import_eccrypto, import_lodash2, import_pump, modalDOMElementID, storeKey, UX_MODE, OPENLOGIN_METHOD, ALLOWED_INTERACTIONS, OPENLOGIN_NETWORK, SUPPORTED_KEY_CURVES, LOGIN_PROVIDER, log2, htmlToElement, sessionStorageAvailable, localStorageAvailable, handleStream, Modal, MemoryStore, OpenLoginStore, Provider, OpenLogin;
var init_openlogin_esm = __esm({
  "../node_modules/@toruslabs/openlogin/dist/openlogin.esm.js"() {
    ...
    log2 = import_loglevel2.default.getLogger("openlogin");
    ...
    OpenLogin = function() {
      function OpenLogin2(options) {
        ...
        this.initState(_objectSpread2(_objectSpread2({}, options), {}, {
      ...
      _createClass(OpenLogin2, [{
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    this._syncState({
                      originData: _objectSpread2(_objectSpread2({}, whitelist), filteredOriginData),
                      whiteLabel: _objectSpread2(_objectSpread2({}, whiteLabel), this.state.whiteLabel)
                    });
                  case 9:
                  case "end":
                    return _context2.stop();
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 18:
                    ...
                    params = [_objectSpread2(_objectSpread2({}, session), params[0])];
        ...
        value: function _syncState(newState) {
          ...
          this.state = _objectSpread2(_objectSpread2(_objectSpread2({}, this.state), newState), {}, {
            store
          });
        }
      }, {
...
//# sourceMappingURL=chunk-QDADR27D.js.map
