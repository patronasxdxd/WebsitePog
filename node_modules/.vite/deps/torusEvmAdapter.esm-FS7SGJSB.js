...
} from "./chunk-N26OLTN6.js";
import {
  require_fast_deep_equal,
  require_is_stream
} from "./chunk-ZJ6EM36C.js";
import {
  BaseEvmAdapter,
  init_baseEvmAdapter_esm
} from "./chunk-LCEVKULV.js";
import {
...
function createErrorMiddleware() {
  return (req, res, next) => {
    ...
    next((done) => {
      ...
      log3.error(`MetaMask - RPC Error: ${error.message}`, error);
      return done();
    });
  };
}
...
var import_lodash2, import_obs_store, import_eth_rpc_errors, import_fast_deep_equal, import_is_stream, import_pump, import_loglevel2, import_create_hash, import_events, LOGIN_PROVIDER, WALLET_VERIFIERS, WALLET_OPENLOGIN_VERIFIER_MAP, PAYMENT_PROVIDER, SUPPORTED_PAYMENT_NETWORK, TORUS_BUILD_ENV, BUTTON_POSITION, CRYPTO_COMPARE_CURRENCIES, PROVIDER_SUPPORTED_FIAT_CURRENCIES, cryptoCompareCurrenciesSet, paymentProviders$1, translations, configuration, runOnLoad, htmlToElement, handleEvent, handleStream, log3, messages, paymentProviders, validatePaymentProvider, getPreopenInstanceId, getTorusUrl, getUserLanguage, EMITTED_NOTIFICATIONS, NOOP, FEATURES_PROVIDER_CHANGE_WINDOW, FEATURES_DEFAULT_WALLET_WINDOW, FEATURES_CONFIRM_WINDOW, getRpcPromiseCallback, TorusInpageProvider, defaults, hashes, integrity, main, PopupHandler, getSiteName, getSiteMetadata, _excluded, defaultVerifiers, iframeIntegrity, expectedCacheControlHeader, UNSAFE_METHODS, Torus;
var init_torus_esm = __esm({
  "../node_modules/@toruslabs/torus-embed/dist/torus.esm.js"() {
    ...
    import_create_hash = __toESM(require_browser2());
    ...
    log3 = import_loglevel2.default.getLogger("torus-embed");
    messages = {
      errors: {
    ...
    getTorusUrl = async (buildEnv, integrity2) => {
      ...
      try {
        ...
        log3.error(error, "unable to fetch latest version");
      }
      log3.info("version used: ", versionUsed);
      switch (buildEnv) {
        case "binance":
    ...
    TorusInpageProvider = class extends SafeEventEmitter {
      ...
      get publicConfigStore() {
        if (!this._sentWarnings.publicConfigStore) {
          log3.warn(messages.warnings.publicConfigStore);
      ...
      async _initializeState() {
        try {
          ...
          log3.error("MetaMask: Failed to get initial state. Please report this bug.", error);
        } finally {
          log3.info("initialized state");
      ...
      send(methodOrPayload, callbackOrArgs) {
        if (!this._sentWarnings.send) {
          log3.warn(messages.warnings.sendDeprecation);
      ...
      _handleConnect(chainId) {
        if (!this._state.isConnected) {
          ...
          log3.debug(messages.info.connected(chainId));
        }
      }
      /**
      ...
      _handleAccountsChanged(accounts) {
        ...
        if (!Array.isArray(finalAccounts)) {
          log3.error("MetaMask: Received non-array accounts parameter. Please report this bug.", finalAccounts);
          finalAccounts = [];
        }
        for (const account of accounts) {
          if (typeof account !== "string") {
            log3.error("MetaMask: Received non-string account. Please report this bug.", accounts);
            finalAccounts = [];
            break;
          }
        }
        if (!(0, import_fast_deep_equal.default)(this._state.accounts, finalAccounts)) {
          if (isEthAccounts && Array.isArray(this._state.accounts) && this._state.accounts.length > 0 && !isInternal) {
            log3.error('MetaMask: "eth_accounts" unexpectedly updated accounts. Please report this bug.', finalAccounts);
          }
      ...
      _handleChainChanged() {
        ...
        if (!chainId || !networkVersion) {
          log3.error("MetaMask: Received invalid network parameters. Please report this bug.", {
            chainId,
            networkVersion
          });
          return;
      ...
      _handleUnlockStateChanged() {
        ...
        if (typeof isUnlocked !== "boolean") {
          log3.error("MetaMask: Received invalid isUnlocked parameter. Please report this bug.", {
            isUnlocked
          });
          return;
        }
      ...
      _warnOfDeprecation(eventName) {
        if (this._sentWarnings.events[eventName] === false) {
          log3.warn(messages.warnings.events[eventName]);
    ...
    PopupHandler = class extends import_events.EventEmitter {
      constructor(_ref) {
        let {
          url,
          target,
    ...
    iframeIntegrity = "sha384-gBoLisZoICU+G5W0Fuuawddb4Ye/F7ZtmRPRdzUnPXC/PqK9E5nbGY7WXv2uJwY0";
    ...
    Torus = class {
      ...
      async init() {
        ...
        log3.setDefaultLevel(logLevel2);
        if (enableLogging)
          log3.enableAll();
        else
          log3.disableAll();
      ...
      ></iframe>`);
        ...
        const mergedTranslations = (0, import_lodash2.default)(configuration.translations, customTranslations);
        ...
        if (buildEnv === "production" && integrity2.check) {
          ...
          log3.info(calculatedIntegrity, "integrity");
      ...
      _setupWeb3() {
        ...
        log3.debug("Torus - injected provider");
      }
...
//# sourceMappingURL=torusEvmAdapter.esm-FS7SGJSB.js.map
